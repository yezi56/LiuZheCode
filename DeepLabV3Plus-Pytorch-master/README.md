...
## Ubuntu GPU Quick Start For `black_rot`

This repo now includes a server launcher for the current `black_rot` dataset.
...
See [SERVER_GPU_UBUNTU.md](SERVER_GPU_UBUNTU.md) for the full server guide.
